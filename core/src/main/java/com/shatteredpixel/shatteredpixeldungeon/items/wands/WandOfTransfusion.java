...
public class WandOfTransfusion extends Wand {
		...
		if (ch instanceof Mob){
			...
			//for enemies...
				...
				//harms the undead
					...
					ch.damage(Random.NormalIntRange(2 + buffedLvl(), 4+buffedLvl()), this);
	...
	public String statsDesc() {
		...
		if (levelKnown)
			return Messages.get(this, "stats_desc", selfDMG, selfDMG + 3*buffedLvl(), 5+buffedLvl(), (int)((2+buffedLvl()/2) * powerMultiplier()), (int)((4+ buffedLvl()) * powerMultiplier()));
		else
			return Messages.get(this, "stats_desc", selfDMG, selfDMG, 5, (int)(2 * powerMultiplier()), (int)(4 * powerMultiplier()));
	}
