...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			ARMOR.classes = new Class<?>[]{
					...
					DuelistArmor.class};
			ARMOR.probs = new float[]{ 1, 0, 0, 0, 0, 0 };
			...
			RING.probs = new float[]{ 1, 1, 1, 1, 1, 1, 1, 1, 1 };
	...
	public static MeleeWeapon randomArmor(){
		return randomArmor(Dungeon.depth / 5);
	}
	
	public static MeleeWeapon randomArmor(int floorSet) {
		return randomWeapon(floorSet);
	}
