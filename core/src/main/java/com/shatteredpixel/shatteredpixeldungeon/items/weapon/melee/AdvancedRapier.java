...
public class AdvancedRapier extends MeleeWeapon {

	{
		image = ItemSpriteSheet.ADVRAPIER;
	...
	public int max(int lvl) {
		return  4*(4) +    //16 base, down from 30
				lvl*(4);   //+4 per level, down from +6
	}
		...
		hero.sprite.jump(hero.pos, dest, 0, 0.1f, new Callback() {
			...
			public void call() {
				...
				if (enemy != null) {
					...
					beforeAbilityUsed(hero);
					GLog.w(Messages.get(AdvancedRapier.class, "ability_no_target"));
