...
public class ItemSpriteSheet {
	...
	public static final int PHAN_ARROW      = UNCOLLECTIBLE+7;
	...
	static{
		...
		assignItemRect(PHAN_ARROW,    11, 11);
	...
	public static final int PAN             = WEP_TIER2+5;
	public static final int PHAN_BOW        = WEP_TIER2+6;
	static{
		...
		assignItemRect(PAN,             14, 14);
		assignItemRect(PHAN_BOW,        16, 16);
	}
	...
	public static final int ADVRAPIER       = WEP_TIER5+6;
	static{
		...
		assignItemRect(ADVRAPIER,   15, 16);
	}
	...
	public static final int ARMOR_BEST_CHARACTER = ARMOR+9;
	...
	static{
		...
		assignItemRect(ARMOR_BEST_CHARACTER,  13, 15);
	}
	...
	public static final int WAND_RED_WARDING    = WANDS+13;
	static {
	...
	public static final int BETTER_PICKAXE = QUEST+9;
	static{
		...
		assignItemRect(BETTER_PICKAXE, 16, 16);
	}
	...
	public static final int LORE_PAGE   = DOCUMENTS+7;
	static{
		...
		assignItemRect(LORE_PAGE,   10, 11);
	}
