...
public enum Talent {
	...
	//Warrior T2
	IRON_STOMACH(4), RESTORED_WILLPOWER(5), RUNIC_TRANSFERENCE(6), LETHAL_MOMENTUM(7, 3), IMPROVISED_PROJECTILES(8),
	//Warrior T3
	HOLD_FAST(101), STRONGMAN(10, 3),
	//Berserker T3
	ENDLESS_RAGE(11, 3), DEATHLESS_FURY(12, 3), ENRAGED_CATALYST(13, 3),
	//Gladiator T3
	CLEAVE(14, 3), LETHAL_DEFENSE(15, 3), ENHANCED_COMBO(16, 3), SKILL(28,3),
	//Heroic Leap T4
	...
	//Battlemage T3
	EMPOWERED_STRIKE(43, 3), MYSTICAL_CHARGE(44, 3), EXCESS_CHARGE(45, 3), PYROMANIAC(30, 3),
	//Warlock T3
	SOUL_EATER(46, 3), SOUL_SIPHON(47, 3), NECROMANCERS_MINIONS(48, 3), BANISHED(31, 3),
	//Elemental Blast T4
	...
	//Freerunner T3
	EVASIVE_ARMOR(78, 3), PROJECTILE_MOMENTUM(79, 3), SPEEDY_STEALTH(80, 3), FREERUNNER_EATING(29, 3),
	//Smoke Bomb T4
	...
	//Champion T3
	SECONDARY_CHARGE(139, 3), TWIN_UPGRADES(140, 3), COMBINED_LETHALITY(141, 3), SWINGY_EXPERIENCE(59, 3),
	//Monk T3
	UNENCUMBERED_SPIRIT(142, 3), MONASTIC_VIGOR(143, 3), COMBINED_ENERGY(144, 3), ABILITY_PROTECTION(60, 3),
	//Challenge T4
...
//					return 26;
	...
	public static void onTalentUpgraded( Hero hero, Talent talent ){
		...
		if (talent == UNENCUMBERED_SPIRIT && hero.pointsInTalent(talent) == 3){
			Item toGive = new Gloves().identify();
			if (!toGive.collect()){
	...
	public static void onFoodEaten( Hero hero, float foodVal, Item foodSource ){
		...
		if (hero.hasTalent(EMPOWERING_MEAL)){
			//2/3 bonus wand damage for next 3/5 zaps
			Buff.affect( hero, WandEmpower.class).set(1 + hero.pointsInTalent(EMPOWERING_MEAL), 1 + hero.pointsInTalent(EMPOWERING_MEAL)*2);
...
//				break;
			case MAGE:
				...
				break;
			case ROGUE:
				Collections.addAll(tierTalents, MYSTICAL_MEAL, MYSTICAL_UPGRADE, WIDE_SEARCH, SILENT_STEPS, IMPROVISED_PROJECTILES);
				break;
			case HUNTRESS:
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case SNIPER:
				...
				break;
			case CHAMPION:
				Collections.addAll(tierTalents, SECONDARY_CHARGE, TWIN_UPGRADES, COMBINED_LETHALITY, SWINGY_EXPERIENCE);
				break;
			case MONK:
				Collections.addAll(tierTalents, UNENCUMBERED_SPIRIT, MONASTIC_VIGOR, COMBINED_ENERGY, ABILITY_PROTECTION);
				break;
		}
		for (Talent talent : tierTalents){
			talents.get(2).put(talent, 0);
